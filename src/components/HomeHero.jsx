  ...
  return (
   <div
        ...
        <header className="flex w-full justify-between">
          ...
          <div className="my-6 mx-4">
            <Link  className="rounded bg-[#e50a14] py-2 px-8 text-white" to="/login">Signin</Link>
          </div>
        </header>
        <main className=" flex flex-1 flex-col items-center justify-center sm:px-20">
           <h1 className="max-w-lg text-5xl font-bold tracking-wide text-white"> Unlimitted Movies, TV shows , and more.</h1>
              <h2 className="mt-4 mb-8 text-2xl text-white">Watch any where, Cancel any time </h2>
              <p className="text-lg text-white">ready to watch ? enter your email to create or restart your memebership</p>
          <div className="m-4 flex flex-col gap-6 text-white sm:flex-row sm:gap-0">
                 <input type='text' placeholder="Enter your email" className="w-full min-w-[400px] bg-white px-24 py-4 text-black outline-none sm:p-4"/>
                 <button className=" flex w-full items-center justify-center bg-[#e50914] py-2 text-xl  sm:py-0 sm:px-8">Get Started
